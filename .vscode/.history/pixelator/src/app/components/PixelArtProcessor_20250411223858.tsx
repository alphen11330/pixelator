...
const bayerMatrixBasic = [
  [8, 15, 47, 63, 63, 47, 15, 8],
  [15, 31, 63, 47, 47, 63, 31, 15],
  [47, 63, 31, 15, 15, 31, 63, 47],
  [63, 47, 15, 8, 8, 15, 47, 63],
  [63, 47, 15, 8, 8, 15, 47, 63],
  [47, 63, 31, 15, 15, 31, 63, 47],
  [15, 31, 63, 47, 47, 63, 31, 15],
  [8, 15, 47, 63, 63, 47, 15, 8],
...
const bayerMatrixInvertPolkadot = [
  [0, 15, 55, 63, 63, 55, 15, 0],
  [15, 47, 63, 55, 55, 63, 47, 15],
  [55, 63, 47, 15, 15, 47, 63, 55],
  [63, 55, 15, 0, 0, 15, 55, 63],
  [63, 55, 15, 0, 0, 15, 55, 63],
  [55, 63, 47, 15, 15, 47, 63, 55],
  [15, 47, 63, 55, 55, 63, 47, 15],
  [0, 15, 55, 63, 63, 55, 15, 0],
...
const invertedBayerMatrix = [
  [0, 15, 47, 63, 63, 47, 15, 0],
  [15, 31, 63, 47, 47, 63, 31, 15],
  [47, 63, 31, 15, 15, 31, 63, 47],
  [63, 47, 15, 0, 0, 15, 47, 63],
  [63, 47, 15, 0, 0, 15, 47, 63],
  [47, 63, 31, 15, 15, 31, 63, 47],
  [15, 31, 63, 47, 47, 63, 31, 15],
  [0, 15, 47, 63, 63, 47, 15, 0],
