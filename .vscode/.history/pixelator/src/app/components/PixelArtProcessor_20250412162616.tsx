...
const bayerMatrixMeshLight = [
  ...
  [32, 16, 40, 48, 48, 40, 16, 32],
  [48, 40, 24, 32, 32, 24, 40, 48],
  [56, 48, 32, 16, 16, 32, 48, 56],
  [56, 48, 32, 16, 16, 32, 48, 56],
  [48, 40, 24, 32, 32, 24, 40, 48],
  [32, 16, 40, 48, 48, 40, 16, 32],
  [0, 32, 48, 56, 56, 48, 32, 0],
...
const bayerMatrixMeshDark = [
  ...
  [32, 48, 24, 16, 16, 24, 48, 32],
  [16, 24, 40, 32, 32, 40, 24, 16],
...
const bayerMatrixPolkadotLight = [
  ...
  [16, 32, 48, 63, 63, 48, 32, 16],
  [32, 48, 63, 32, 32, 63, 48, 32],
  [48, 63, 32, 16, 16, 32, 63, 48],
  [48, 63, 32, 16, 16, 32, 63, 48],
  [32, 48, 63, 32, 32, 63, 48, 32],
  [16, 32, 48, 63, 63, 48, 32, 16],
  [0, 16, 32, 48, 48, 32, 16, 0],
...
const bayerMatrixPolkadotDark = [
  // ハーフトーン（明）
  [63, 48, 32, 16, 16, 32, 48, 63],
  [48, 32, 16, 0, 0, 16, 32, 48],
  [32, 16, 0, 32, 32, 0, 16, 32],
  [16, 0, 32, 48, 48, 32, 0, 16],
  [16, 0, 32, 48, 48, 32, 0, 16],
  [32, 16, 0, 32, 32, 0, 16, 32],
  [48, 32, 16, 0, 0, 16, 32, 48],
  [63, 48, 32, 16, 16, 32, 48, 63],
