...
type Props = {
  editMode: string; // ["none", "brush", "eraser", "bucket", "hand", "line"]
    ...
    <>
      <div className={style.toolBar}>
        ...
        <div
          ...
          style={{ textShadow: "10px 10px 10px rgb(255, 0, 0)" }}
          onClick={
            editMode == "brush"
              ? () => setEditMode("none")
              : () => setEditMode("brush")
        ...
        {/* 消しゴム */}
        <div
          className={editMode == "eraser" ? style.activeToolBox : style.toolBox}
          onClick={
            editMode == "eraser"
              ? () => setEditMode("none")
              : () => setEditMode("eraser")
        ...
        {/* バケツ */}
        <div
          className={editMode == "bucket" ? style.activeToolBox : style.toolBox}
          onClick={
            editMode == "bucket"
              ? () => setEditMode("none")
              : () => setEditMode("bucket")
        ...
        {/* 手 */}
        <div
          className={editMode == "hand" ? style.activeToolBox : style.toolBox}
          onClick={
            editMode == "hand"
              ? () => setEditMode("none")
              : () => setEditMode("hand")
        ...
        {/* 直線 */}
        <div
          className={editMode == "line" ? style.activeToolBox : style.toolBox}
          onClick={
            editMode == "line"
              ? () => setEditMode("none")
              : () => setEditMode("line")
