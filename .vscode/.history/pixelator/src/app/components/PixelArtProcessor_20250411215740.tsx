...
const bayerMatrixBasic = [
  [63, 58, 50, 45, 45, 50, 58, 63], // row 0 (そのまま)
  [48, 36, 27, 27, 36, 48, 58, 58], // row 1 (左に4ピクセルシフト)
  [20, 10, 10, 20, 36, 50, 50, 36], // row 2
  [0, 0, 10, 27, 45, 45, 27, 10], // row 3
  [10, 27, 45, 45, 27, 10, 0, 0], // row 4
  [36, 50, 50, 36, 20, 10, 10, 20], // row 5
  [58, 58, 48, 36, 27, 27, 36, 48], // row 6
  [63, 63, 58, 50, 45, 45, 50, 58], // row 7
];
