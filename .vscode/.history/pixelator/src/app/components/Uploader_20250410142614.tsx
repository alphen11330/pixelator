...
const Uploader: React.FC<Props> = ({ setImageSrc, setSmoothImageSrc }) => {
  ...
  const boxStyle: React.CSSProperties = {
    ...
    marginTop: "1rem",
    padding: "10px 15px",
    border: "2px solid hsl(190, 39.40%, 49.20%)",
    borderRadius: "5px",
  ...
  return (
    <>
      <label
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.backgroundColor = "hsl(198, 51.70%, 70.80%)")
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.backgroundColor = "hsl(190, 59.30%, 88.40%)")
        }
      >
        <div className="select-none">画像を選択</div>
      </label>
      <input
        id="file-upload"
        type="file"
