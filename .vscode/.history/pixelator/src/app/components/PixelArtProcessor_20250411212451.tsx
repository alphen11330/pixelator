...
const bayerMatrixClassic = [
  [12, 45, 28, 2, 59, 16, 40, 7],
  [33, 6, 51, 24, 10, 55, 30, 38],
  [17, 61, 9, 36, 49, 14, 43, 26],
  [4, 34, 47, 20, 1, 60, 23, 57],
  [50, 18, 42, 11, 31, 5, 63, 21],
  [8, 37, 53, 27, 13, 48, 15, 58],
  [41, 22, 3, 52, 29, 46, 35, 0],
  [62, 25, 19, 56, 32, 39, 44, 6],
];
const bayerMatrixCRT = [
  [8, 8, 8, 8, 8, 8, 8, 8],
...
const bayerMatrixCRT_Diagonal8x8 = [
