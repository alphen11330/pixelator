...
import hueShiftProcessor from "./hueShiftProcessor";
...
const ImageEditor: React.FC<Props> = ({
  ...
  useLayoutEffect(() => {
    ...
    imgElement.onload = () => {
      ...
      // 処理ステップ4: 色相統一処理
      if (colorCollection) {
        let reduced = colorCollectionProcessor(cv, dst);
        dst.delete();
        dst = reduced;
      }
  ...
  }, [imageSrc, grayscale, invertColor, colorReduction, colorLevels, hueShift]);
