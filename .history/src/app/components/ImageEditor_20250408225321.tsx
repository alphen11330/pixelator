...
import edgeEnhancementProcessor from "./edgeEnhancementProcessor ";
...
const ImageEditor: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    imgElement.onload = () => {
      ...
      // 処理ステップ4: 輪郭線強調処理（新規追加）
      if (edgeEnhancement) {
        let enhanced = edgeEnhancementProcessor(
          cv,
          dst,
          edgeThickness,
          edgeIntensity
