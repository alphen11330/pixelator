...
const colorReductionProcessor = (dataUrl: string, colorPalette: string[], { dotsImageSrc, colorPalette }: Props): Promise<string> => {
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      if (!ctx) return reject("Canvasのコンテキストが利用できません");
