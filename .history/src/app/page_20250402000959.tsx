...
export default function PixelArtConverter() {
  ...
  const [hueShift, setHueShift] = useState(false); // 色相統一処理の判定
  const [hueLevels, setHueLevels] = useState(60); // 色相レベル
  ...
  return (
    <>
      ...
      <br />
      <CheckBox name={"色相統一"} value={hueShift} setValue={setHueShift} />
      <br />
      <br />
    </>
  );
