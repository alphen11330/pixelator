...
export default function PixelArtConverter() {
  ...
  const dotsBox: React.CSSProperties = {
    ...
    conic-gradient(
      from 0deg,
      rgb(204, 204, 204) 25%, rgb(255, 255, 255) 25%, rgb(255, 255, 255) 50%,
      rgb(204, 204, 204) 50%, rgb(204, 204, 204) 75%, rgb(255, 255, 255) 75%, rgb(255, 255, 255) 100%
    )`,
    backgroundSize: "5%px 5%",
  };
